...
export const LoginForm: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!success) {
      setError('Invalid credentials. Use admin/dhp123');
    }
  };
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-background via-muted/20 to-primary/5">
      <div className="w-full max-w-md space-y-6">
        <div className="text-center">
          ...
          <h1 className="text-3xl font-bold text-foreground">DHPII Platform</h1>
          <p className="text-muted-foreground mt-2">Data Privacy & Governance Platform</p>
        </div>
          ...
          <CardContent>
            ...
            <div className="mt-6 text-center">
              <div className="text-sm text-muted-foreground bg-muted/30 p-3 rounded-lg border">
                ...
                <p>Password: <span className="font-mono">dhp123</span></p>
              </div>
            </div>
          </CardContent>
        </Card>
